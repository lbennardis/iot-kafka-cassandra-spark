...
public final class JavaDirectKafkaCassandraPrepare4Kmeans {
 ...
 |-- vehicleType: string (nullable = true)
    ...
    nonFilteredIotDataStream.foreachRDD(rdd ->
    {
    	...
    	*/
    	...
    	//***AGGIUNGE IL VETTORE CON LE FEATURE DA UTILIZZARE PER CALCOLARE IL KMEANS
    	VectorAssembler assembler1 = new VectorAssembler()
    	        .setInputCols(new String[]{"latitude", "longitude"})
    	        .setOutputCol("features");
    			
    	Dataset<Row> assembled1 = assembler1.transform(dataSetData);
    	
    	System.out.println("+++++++++++++++"); 
    	System.out.println("+++++++++++++++ assembled1 " ); 
    	...
    	//mapping JSON e tabelle Cassandra
