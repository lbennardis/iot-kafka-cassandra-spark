 ...
 *      topic1,topic2
 */
public final class JavaDirectKafkaWordCountCassandra {

private static final Logger logger = Logger.getLogger(JavaDirectKafkaWordCountCassandra.class);

public static void main(String[] args) {


SparkConf conf = new SparkConf();
conf.setAppName("JavaDirectKafkaWordCountCassandra");
