...
import it.luigibennardis.iot.streaming.util.PropertyFileConfigurationReader;
...
public final class StreamingKafkaCassandra {
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  Properties prop = PropertyFileConfigurationReader.readPropertyFile();		
		...
		String brokers = prop.getProperty("it.luigibennardis.iot.dataproducer.kafka.brokerlist");
		String topics = prop.getProperty("it.luigibennardis.iot.dataproducer.kafka.vehicleTopic");
	
    // Create context with a 5 seconds batch interval
    SparkConf sparkConf = new SparkConf().setAppName("StreamingKafkaCassandra");
    ...
    */    
	...
	//process data
	 ...
	 //broadcast variables. We will monitor vehicles on A24 which are of type tir
	 Broadcast<Tuple3<POIData, String, String>> broadcastPOIValues = jssc.sparkContext().broadcast(new Tuple3<>(poiData,"A24","TIR"));
